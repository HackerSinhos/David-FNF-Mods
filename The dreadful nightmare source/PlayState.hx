...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'burning':
				dialogue = CoolUtil.coolTextFile(Paths.txt('burning/burningDialogue'));
			case 'disgust':
				dialogue = CoolUtil.coolTextFile(Paths.txt('disgust/disgustDialogue'));
			case 'wake':
				dialogue = CoolUtil.coolTextFile(Paths.txt('wake/wakeDialogue'));
		}
