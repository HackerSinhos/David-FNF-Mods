...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'rematch':
				dialogue = CoolUtil.coolTextFile(Paths.txt('rematch/rematchDialogue'));
			case 'replacement':
				dialogue = CoolUtil.coolTextFile(Paths.txt('replacement/replacementDialogue'));
			case 'tired':
				dialogue = CoolUtil.coolTextFile(Paths.txt('tired/tiredDialogue'));
		}
		...
		switch(SONG.stage)
		{
			...
			case 'schoolEvil':
			{
					...
					bg.frames = Paths.getSparrowAtlas('christmas/evilBG','week5');
		...
		healthBar.createFilledBar(0xFF000000, 0xFFADD8E6);
		// healthBar
		add(healthBar);
