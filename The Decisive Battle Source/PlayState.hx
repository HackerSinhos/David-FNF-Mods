...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'distant':
				dialogue = CoolUtil.coolTextFile(Paths.txt('distant/distantDialogue'));
			case 'resonance':
				dialogue = CoolUtil.coolTextFile(Paths.txt('resonance/resonanceDialogue'));
			case 'incoming':
				dialogue = CoolUtil.coolTextFile(Paths.txt('incoming/incomingDialogue'));
			case 'ending':
				dialogue = CoolUtil.coolTextFile(Paths.txt('ending/endingDialogue'));
		}
		...
		healthBar.createFilledBar(0xFF000000, 0xFF00008B);
		// healthBar
		add(healthBar);
