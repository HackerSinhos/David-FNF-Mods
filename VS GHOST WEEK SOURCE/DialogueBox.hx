	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'thorns':
				...
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			case 'phantom':
				FlxG.sound.playMusic(Paths.music('GhostTalk'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
			case 'specter':
				FlxG.sound.playMusic(Paths.music('GhostTalk'), 0);
				FlxG.sound.music.fadeIn(1, 0, 0.8);
		...
		portraitLeft.frames = Paths.getSparrowAtlas('ghost-portrait', 'shared');
		portraitLeft.animation.addByPrefix('enter', 'ghost-portrait', 24, false);
