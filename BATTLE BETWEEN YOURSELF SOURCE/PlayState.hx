...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'identity':
				dialogue = CoolUtil.coolTextFile(Paths.txt('identity/identityDialogue'));
			case 'crisis':
				dialogue = CoolUtil.coolTextFile(Paths.txt('crisis/crisisDialogue'));
			case 'humanity':
				dialogue = CoolUtil.coolTextFile(Paths.txt('humanity/humanityDialogue'));
			case 'restored':
				dialogue = CoolUtil.coolTextFile(Paths.txt('restored/restoredDialogue'));
		}
