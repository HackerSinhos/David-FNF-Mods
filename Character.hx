		...
		switch (curCharacter)
		{
			...
			case 'dad':
				...
				playAnim('idle');
							...
							case 'sus':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('sus','shared');
				frames = tex;
				...
				playAnim('idle');
							...
							case 'creeper':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('creeper','shared');
				frames = tex;
				animation.addByPrefix('idle', 'creeper idle dance', 24);
				animation.addByPrefix('singUP', 'creeper Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'creeper Sing Note RIGHT', 24);
				animation.addByPrefix('singDOWN', 'creeper Sing Note DOWN', 24);
				animation.addByPrefix('singLEFT', 'creeper Sing Note LEFT', 24);
